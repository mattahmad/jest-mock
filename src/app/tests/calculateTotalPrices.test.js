// tests/calculateTotalPrices.test.js
import { calculateTotalPrice } from './../pages/calculateTotalPrices'; // Import the function we want to test

// Mock the cart module
jest.mock('./../pages/calculateTotalPrices', () => ({
  ...jest.requireActual('./../pages/calculateTotalPrices'), // Import and retain the original functionality
